...
- **v46 전처리 전면 개편 + 학습 데이터 재구성**
- 학습 데이터: 15개 노래(61.5분) + 1개 대화(3.6분) = 65.1분 (이전 22.2분에서 3배 증가)
- v40 모델 해부: F0 상관계수 0.35의 근본 원인 = 대화 48% + 노래 11.6분 + 고음 3.9%
- **v45 변환 파라미터**: index 0.30, rms 0.0, protect 0.33, filter_radius 3
- **v45 후처리 체인**:
