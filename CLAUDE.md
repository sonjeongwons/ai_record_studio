...
| 후처리 (공통) | agate + HPF 80Hz + 800Hz -1.5 + 1.2kHz -0.5 + 5kHz -1.0 + 8kHz -0.5 + 디에서(6.5k -1.0, 9k -0.5) + **10kHz +1.5 Air** + loudnorm | v54 |
| **백킹 보컬** | **완전 제거** (리드 보컬만 사용) | v54: 화음 발음 뭉개짐 해소 |
| 믹스 후처리 | 리미터 0.89 + **원곡 LUFS 매칭** (2-pass, 원곡 측정→매칭) | v54 |
