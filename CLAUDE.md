...
| Epochs | **150** (기본값), Batch: **8**, SR: 40kHz | v49.4: batch→8 (AI Hub: >30분=8) |
| F0 | RMVPE (+ **f0_autotune=True, strength=0.6**) | v49: 노래 피치 안정화 |
| **index_rate** | **0.45** (한국어 0.55 / 영어 0.35) | v49: 한/영 프리셋 분리 |
| **rms_mix_rate** | **0.0** | 원곡 다이나믹 100% 보존 |
| **protect** | **0.40** | v49: 0.33→0.40 (과도한 자음보호 완화→인덱스 정확도↑) |
| **filter_radius** | **3** (한국어 4) | v49: 2→3 (피치 스무딩 강화→크래킹 감소) |
| **hop_length** | **128** | v49: 64→128 (커뮤니티 표준, 64=노이즈추적→삑사리) |
...
| split_audio | **>180초** (3분) 분할 | v49: 300→180초 (경계 아티팩트 감소) |
